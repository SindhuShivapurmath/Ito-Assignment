...
public class DataTypeConversion implements CommandLineRunner{
	public static void main(String[] args) throws Exception {
		DataTypeConversion collections=new DataTypeConversion();
		collections.run();
	}
	...
	public static Timestamp dateToTimestamp() { 
        Timestamp ts=new Timestamp(new Date(0).getTime());  
